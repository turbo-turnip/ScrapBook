...
CREATE TABLE `blocked_user` (
    ...
    INDEX `blocked_user_userID_fkey`(`userID`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `community_member` (
    ...
    INDEX `community_member_communityID_fkey`(`communityID`),
    INDEX `community_member_userID_fkey`(`userID`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `community` (
    ...
    INDEX `community_memberID_fkey`(`memberID`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `video` (
    ...
    INDEX `video_postID_fkey`(`postID`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `message` (
    ...
    INDEX `message_directMessageID_fkey`(`directMessageID`),
...
CREATE TABLE `reaction` (
    ...
    INDEX `reaction_messageID_fkey`(`messageID`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
